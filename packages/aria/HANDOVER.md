...
Green on the current tree: `bun test` passes in aria (577), core (938),
testing (98), server (122), primitives (246), router (517), start (189),
css (60) and query (15). `bunx tsc --noEmit` is clean in `packages/aria` and
