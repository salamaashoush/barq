...
const ROWS: readonly CensusRow[] = [
  ...
  { fixture: "mathml", clones: 2, unattributed: 0, opaque: [] },
  ...
  { fixture: "nested-template-element", clones: 2, unattributed: 0, opaque: [] },
  ...
  { fixture: "props-rest-spread", clones: 1, unattributed: 0, opaque: [] },
  ...
  { fixture: "select-option-multiple", clones: 2, unattributed: 0, opaque: [] },
  ...
  { fixture: "spread-static-mix", clones: 0, unattributed: 0, opaque: [] },
  ...
  { fixture: "use-memo-derived", clones: 1, unattributed: 0, opaque: [] },
  { fixture: "use-state-tuple", clones: 1, unattributed: 0, opaque: [] },
  { fixture: "use-store-member", clones: 1, unattributed: 0, opaque: [] },
