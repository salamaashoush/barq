...
import { compileFixture, compileSource, emittedCalls, fixtureSource, listFixtures } from "./harness.ts"
...
describe("compile throughput", () => {
  it("every fixture compiles under the per-file budget", () => {
    ...
    expect(compiled, "the timings above have to be timings of a real compile").toBeGreaterThanOrEqual(
      40,
    )
