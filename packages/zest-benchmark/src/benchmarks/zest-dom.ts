/**
 * Benchmark: Zest DOM Performance
...
export async function runZestDOMBenchmarks(): Promise<BenchmarkResult[]> {
  ...
  results.push(
    await benchmark("zest-dom", "zest", "create nested (3 levels)", () => {
      h(
        "div",
        { class: "container" },
  ...
  results.push(
    await benchmark("zest-dom", "zest", "create nested (10 levels)", () => {
  ...
  results.push(
    await benchmark("zest-dom", "zest", "create with 10 attrs", () => {
      h("div", {
        id: "test",
        class: "foo bar baz",
        "data-a": "1",
