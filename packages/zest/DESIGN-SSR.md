# Zest SSR Design Document

## Overview

Full isomorphic SSR support for zest - same components render on server and client seamlessly.
...
```typescript
import { renderToStringAsync } from "zest/server"
import { App } from "./App"
...
```typescript
import { useState, useResource, Show, For } from "zest"
